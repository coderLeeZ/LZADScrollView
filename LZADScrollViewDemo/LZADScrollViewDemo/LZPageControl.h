...
@interface LZPageControl : UIControl
/**
 ...
 */
@property(nonatomic,assign) id<LZPageControlDelegate> delegate;
...
@protocol LZPageControlDelegate <NSObject>

@optional
- (void)LZPageControl:(LZPageControl *)pageControl didSelectPageAtIndex:(NSInteger)index;
